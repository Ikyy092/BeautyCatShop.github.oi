...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/josh.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Beauty CatShop</h1>
            <h2 class="subheading mb-4">Menjual Berbagai Macam Kebutuhan Dan Peralatan Hewan Kesayanganmu</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/kucing1.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            ...
            <h2 class="subheading mb-4">Barang Yang Dijual Aman Untuk Hewan Kesayanganmu</h2>
            <p><a href="#products" class="btn btn-info">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/kucing5.jpg'); ?>);">
  <div class="container">
